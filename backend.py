...
def init_beam_search(first_node, beam_size):
  ...
  Input: One Node object
  Output: A list of Node objects
  '''
  assert(type(first_node) == Node)
...
def run_search(candidates, beam_size=3):
  '''
  Input: A list of nodes (candidates) to start the beam search
  Output: A list of nodes (candidates) that have been generated by the beam search algorithm
...
def one_step_forward(curr_sentence):
    ...
    Output: the best sentence that can be generated by adding 5-10 new words to the sentence
    '''
